...
The way to use this FSI_P1 is to subclass Problem to create a class of problems,
...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Expanded nodes list: ", expanded)
            print(count, " nodes has been expanded")
            return node
...
def brunch_and_bound_cost_graph_search(problem):
    return graph_search(problem, BandBCost())

def brunch_and_bound_cost_with_heuristic_graph_search(problem):
    return graph_search(problem, BandBCostAndHeuristic(problem))
